...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::get('/songbooks/{songbook}', [SongbookController::class, 'show'])->name('songbooks.show');
    Route::put('/songbooks/{songbook}', [SongbookController::class, 'update'])->name('songbooks.update');
    Route::delete('/songbooks/{songbook}', [SongbookController::class, 'destroy'])->name('songbooks.destroy');
